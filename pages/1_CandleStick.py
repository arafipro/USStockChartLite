...
if re.match(rep, ticker):
    ...
    fig = go.Figure()
    fig.add_trace(
        go.Scatter(x=df.index, y=df.SMA50, name="50day SMA", line=dict(color="blue"))
    )
    fig.add_trace(
        go.Scatter(x=df.index, y=df.SMA200, name="200day SMA", line=dict(color="red"))
    )
    fig.add_trace(
        go.Scatter(
    ...
    fig.add_trace(
        go.Scatter(x=df.index, y=df.STD, name="base", line=dict(color="#ff6d00"))
    )
    fig.add_trace(
        go.Candlestick(
            name="price",
